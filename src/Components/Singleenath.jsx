...
const Singleenath = () => {
  ...
  return (
    <div className=" w-[100%] rounded-2xl lg:h-[650px] xl:h-[600px] 2xl:h-[790px] h-[600px] flex flex-col">
      <main className="w-fullh-[600px]  lg:h-[575px] xl:h-[480px] 2xl:h-[780px]  sm:h-[475px] flex flex-col overflow-y-scroll">
  ...
  <div className="flex gap-[5px] h-full items-center w-full">
    ...
    <h1 className="text-xl content-center font-semibold text-gray-800">eMandate Master</h1>
...
<table className="w-full text-sm text-left text-gray-600 border border-gray-200 rounded-md overflow-hidden">
  ...
  <div className="flex items-center space-x-2">
    <p>1-10 of 7406</p>
    <button
      className="px-3 py-1  border-gray-300 rounded-md  hover:bg-gray-200"
     
    >
     <i class="fa-solid fa-arrow-left"></i>
    </button>
    <button className="px-3 py-1 border border-gray-300 rounded-md hover:bg-gray-100">1</button>
    <button className="px-3 py-1 border border-gray-300 rounded-md bg-gray-200 font-medium">2</button>
