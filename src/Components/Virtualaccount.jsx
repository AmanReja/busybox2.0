...
const Virtualaccount = () => {
  ...
  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
      ...
      {/* Date Picker */}
      <div className="flex items-center gap-2 border rounded-[8px] border-gray-300">
  <input
    type="date"
    className="border text-gray-400 border-none border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
  />
  <span className="text-gray-500">-</span>
  <input
    type="date"
    className="border border-gray-300 border-none text-gray-400 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
  />
</div>
      ...
      {/* Dropdown */}
      <select 
        className="border border-gray-300 text-gray-400 rounded-md px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
        ...
        <option value="Inactive">Inactive</option>
            ...
            <table className="w-full text-sm text-left text-gray-600 ">
              <thead className="text-xs text-gray-700 uppercase border-b border-gray-300">
                <tr>
                  <th className="px-4 py-2">Customer Details
</th>
